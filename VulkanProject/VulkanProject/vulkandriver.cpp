...
//#include "objects.h"
//
//// model and texture paths - should stay with the api driver
//const std::vector<std::string> MODEL_PATHS = { "models/XWing_Woody.obj" };
//const std::vector<std::string> TEXTURES_XWING = { "textures/Fuselage_CockpitColor.png", "extures/Engines_Color.png" };
//
//void VulkanEngine::run() {
//	texturePaths = { TEXTURES_XWING };
//
//	initWindow();
//	initVulkan();
//	mainLoop();
...
//
///// <summary>
///// Main functions to run the Vulkan engine
///// </summary>
...
//		std::string err;
//
//		if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, MODEL_PATHS[0].c_str())) {
